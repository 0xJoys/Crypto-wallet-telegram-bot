    ...
    <div className='flex flex-col h-fit px-3 py-5 gap-4 items-center'>
      <div className='borde w-full'>
        ...
        <div className='flex gap-2 text-primaryColor px-1 text-xl font-semibold items-center borde mb-3'>
          <FaAngleLeft />
          <h1 className='text-primaryColor'> Expired Deal 01</h1>
        </div>
        <hr />
        ...
        <div className='borde w-full'>
          ...
          <div className='borde w-full'>
            ...
            <div className='borde text-red-500 flex items-center justify-center pt-2'>
              <IoWarning size={25} />
              <h3 className='text-sm italic'>Your Deal Date is expired, please change the date for resubmit.</h3>
            </div>
          </div>
...
export default expiredDealEdit